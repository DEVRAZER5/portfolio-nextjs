export const projects = [
  ...
  },
  {
    ...
    problem:
      "I wanted to learn how to connect a frontend to real logic, Cart, checkout, and data handling, by building a complete e-commerce flow.",
    whatIDid:
      "I built the home page, cart, and checkout following a tutorial, spending the most time on callback functions, Promises, and fetch. The search bar wasn't covered in the tutorial but I solved that on my own.",
    outcome:
  ...
  },
  {
    ...
    problem:
      "I wanted to practice layout techniques and I replicating YouTube's home page: search bar, menu, and video grid, using only HTML and CSS.",
    whatIDid:
      "I built the full home page following a tutorial, focusing on Flexbox and Grid and the biggest challenge was understanding how elements behave when combined.",
    outcome:
  ...
  },
  {
    ...
    whatIDid:
      "I solved every task on my own, a counter, calculator, reaction-time test, click-speed test, rock-paper-scissors, and more by only checking with AI at the end.",
    outcome:
